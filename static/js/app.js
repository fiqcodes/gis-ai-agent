...
function _injectKBStyles() {
  if (document.getElementById('_kbStyleSheet')) return;
  const s = document.createElement('style');
  s.id = '_kbStyleSheet';
  s.textContent = `
    /* ══════════════════════════════════════════════════
       KNOWLEDGE BASE — complete dark-grey reskin
    ══════════════════════════════════════════════════ */
    ...
    .kp-nav-search {
      ...
      border: 1px solid #2e3447 !important;
      color: #e2e8f0 !important;
    ...
    .kp-nav-search:focus { border-color: #f97316 !important; }
    .kp-nav-search::placeholder { color: #64748b !important; }
    ...
    .kp-close-btn { color: #64748b !important; }
    .kp-close-btn:hover { color: #f1f5f9 !important; background: #2a2f3d !important; }

    /* ── Detail content area ─────────────────────────── */
    #kpDetailFull, #kpLanding {
      background: #1a1d23 !important;
    }

    /* ── Hero section ───────────────────────────────── */
    .kpd-page { padding: 28px 32px 48px !important; max-width: 860px !important; }
    .kpd-big-name {
    ...
    .kp-tag-vegetation { background: rgba(34,197,94,.18) !important; color: #4ade80 !important; }
    .kp-tag-water      { background: rgba(56,189,248,.18) !important; color: #38bdf8 !important; }
    .kp-tag-urban      { background: rgba(249,115,22,.18) !important; color: #fb923c !important; }
    .kp-tag-thermal    { background: rgba(239,68,68,.18) !important;  color: #f87171 !important; }
    .kp-tag-atmospheric{ background: rgba(168,85,247,.18) !important; color: #c084fc !important; }
    .kp-tag-landcover  { background: rgba(234,179,8,.18) !important;  color: #facc15 !important; }

    /* ── Info cards (command / datasource) — concl-card style ── */
    .kpd-command-box, .kpd-source-box {
      background: #1e2330 !important;
    ...
    /* ── Formula paper card ──────────────────────────── */
    .kpd-formula-paper-section { margin: 28px 0 !important; }
    .kpd-formula-paper {
      background: #1e2330 !important;
      border: 1px solid #2a2f3d !important;
    ...
    .kpd-formula-paper-inner { margin-bottom: 20px !important; }
    .kpd-formula-render {
    ...
    .kpd-vars-list { display: flex; flex-direction: column; gap: 8px; }
    .kpd-var-row {
      display: flex !important;
    ...
    .kpd-var-eq { color: #64748b !important; }
    .kpd-var-desc { color: #cbd5e1 !important; line-height: 1.5 !important; }
    .kpd-formula-bands-label {
      font-size: 9px !important;
      font-weight: 700 !important;
      letter-spacing: 0.1em !important;
      text-transform: uppercase !important;
    ...
    /* ── Color scale bar ─────────────────────────────── */
    .kpd-scale-section { margin: 28px 0 !important; }
    .kpd-gradient {
    ...
    /* ── Class viz cards (scorecard style) ───────────── */
    .kpd-full-block { margin: 28px 0 !important; }
    .kpd-viz-scale {
      display: flex !important;
    ...
    .kpd-usecase-item svg { color: #f97316 !important; flex-shrink: 0 !important; margin-top: 2px !important; }
    ...
    .kpd-range-high { color: #f97316 !important; }
    .kpd-range-arrow { color: #475569 !important; font-size: 16px !important; }
    ...
    .kp-landing-icon { font-size: 48px !important; opacity: .4 !important; }
    .kp-landing-title { font-size: 16px !important; font-weight: 600 !important; color: #64748b !important; }
    .kp-landing-sub { font-size: 13px !important; color: #475569 !important; }
  `;
